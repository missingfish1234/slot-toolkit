...
Write-Host ''
Write-Host 'Cocos Timeline / Spine Director 3.8 was installed successfully.'
Write-Host "Installed to: $DestinationPath"
Write-Host 'Return to Cocos Creator, refresh Extensions, then enable Cocos Timeline / Spine Director 3.8.'
